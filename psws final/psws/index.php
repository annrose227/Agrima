    ...
    <footer class="page-footer">
      ...
      <div class="footer-nav">
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
            ...
            Head Office: Palai Social Welfare Society.<br>
            Pala, Kottayam. Kerala 686 575.
          </address>
            <div class="phone">
              Telephone:
              <a class="phone__number" href="tel:0123456789"> 04822 210463</a>
            </div>
            <div class="email">
              Email:
              <a href="mailto:support@yourwebsite.com" class="email__addr">dssspalai@gmail.com</a>
            </div>
          </div>
      ...
      <div class="page-footer__subline">
        <div class="container clearfix">
          ...
          <div class="copyright">
            &copy; <?php echo date("Y");?> pwsw marketplace &trade;
          </div>
